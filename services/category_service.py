...
#no se si va este def aca
    def get_product_with_category(self, id_key: int):
        product = self.repository.find(id_key)
        return {
            "name": product.name,
            "price": product.price,
            "stock": product.stock,
            "category_id": product.category_id,
            "category_name": product.category.name  # ✅ Solo el nombre
        }